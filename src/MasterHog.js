    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog name={offspring[0].name} hobby={offspring[0].hobby}/>
          <BabyHog name={offspring[1].name} hobby={offspring[1].hobby}/>
          <BabyHog name={offspring[2].name} hobby={offspring[2].hobby}/>
        </ul>
